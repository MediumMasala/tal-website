...
const TESTIMONIALS = [
  {
    quote: "Got my dream job in 2 weeks. Tal knew exactly what I was looking for.",
    name: "Priya S.",
    role: "Senior Engineer at Razorpay",
    stars: 5,
  },
  {
    quote: "Finally, a job assistant that doesn't spam me with irrelevant roles.",
    name: "Rahul M.",
    role: "Product Manager at CRED",
    stars: 5,
  },
  {
    quote: "The salary insights alone were worth it. Got a 40% hike!",
    name: "Ananya K.",
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {TESTIMONIALS.map((testimonial, index) => (
                <div
                  key={index}
                  className="testimonial-card rounded-2xl p-6 hover:shadow-lg transition-shadow"
                >
                  {/* Stars */}
